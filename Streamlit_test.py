...
# df = pd.read_sql_query(query_customer_retention_rate, engine)
...
#     # format the value to desired format
...
# sns.barplot(x='Year', y='Retention Rate', data=df_customer_retention_rate, ax=ax)

# ax.set_yscale('log')
# ax.set_title('Customer Retention Rate (Log Scale)')
...
# # Plotting with Seaborn
# fig, ax = plt.subplots(figsize=(12,6))
# sns.barplot(y='product_category_name_english', x='order_count', data=df,  palette='viridis', ax=ax)
# ax.set_xlabel('Order Count')
# ax.set_ylabel('Product Category Name (English)')
# ax.set_title('Top 10 Most Popular Product Categories')
